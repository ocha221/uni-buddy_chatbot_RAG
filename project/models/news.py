class News:
    ...
    def to_metadata(self):
        ...
        all_types = ["student-related", "distinctions-awards", "internship-related", 
                    "events-activities", "vacancies"]
        
        for news_type in all_types:
            metadata[f"type_{news_type.replace('-', '_')}"] = news_type in self.news_types
